...
function createCopyButton(label, url) {
...
function createSubscribeLink(url) {
    const link = document.createElement("a");
...
function createCompetition(competition) {
    ...
    item.append(createCopyButton(competition.name, url), createSubscribeLink(url), createDownloadButton(competition.url));
    return item;
}
function createCrest(src) {
...
function createNextFixture(isoDate) {
