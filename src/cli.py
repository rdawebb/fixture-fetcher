...
class CLI:
    ...
    def __init__(self):
        ...
        self.panel_width = console.size.width if console.size.width % 2 == 0 else console.size.width
    ...
    def interactive_prompt(self):
        ...
        if confirm("Do you want to fetch football fixtures?"):
            ...
            selected_competition = select_multiple(competitions, tick_character="⚽️", ticked_indices=[0])
